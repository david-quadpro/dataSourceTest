...
(function() {
    var provider = app.data.dataSourceTest = new Everlive({
            offlineStorage: true,
            appId: 'ldccmmujdlpq0yms',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'dataSourceTest_access_token',
...
// START_CUSTOM_CODE_dataSourceTest
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_dataSourceTest